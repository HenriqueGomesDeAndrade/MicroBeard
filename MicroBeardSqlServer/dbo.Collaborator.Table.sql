USE [MicroBeard]
GO
/****** Object:  Table [dbo].[Collaborator]    Script Date: 30/10/2022 12:22:59 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_COLLABORATOR_CPF]    Script Date: 30/10/2022 12:22:59 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_COLLABORATOR_EMAIL]    Script Date: 30/10/2022 12:22:59 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IDX_COLLABORATOR_TOKEN]    Script Date: 30/10/2022 12:22:59 ******/
CREATE UNIQUE NONCLUSTERED INDEX [IDX_COLLABORATOR_TOKEN] ON [dbo].[Collaborator]
(
	[Token] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
